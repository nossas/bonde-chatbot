...
export default {
  ...
  */
  ...
  // Discurso de ódio
  //
  DISCURSO_ODIO: 'Eu não tenho título de eleitor, mas também não sou robô de ficar de fora das eleições! 🤖  Me juntei a alguns crushes incríveis para criar uma ação de combate ao discurso de ódio praticado por candidaturas e partidos: não podemos deixar que o ódio seja estratégia pra ganhar eleitores! Criamos um jeitinho bem prático de você denunciar conteúdos de ódio e garantir uma rede mais segura. Vem tretar comigo? 😝',
