...
export default {
  ...
  */
  ...
  NASCITURO_QUICK_REPLY_BORA: 'É AGORA! Eu chamo isso de pressão direta: te mostro a mensagem que vamos enviar e mando um email, que sai em seu nome, para cada um dos presidentes da comissões. Tudo aqui mesmo pelo chat! Quando eles abrirem o email e virem que somos MILHARES de pessoas atentas e mobilizadas, vão ter que barrar o projeto. 💪 Clique para enviar sua mensagem. AGORA: ',
  ...
  NASCITURO_QUICK_REPLY_NOW: 'Estamos quase lá! Agora só preciso que você digite seu email - você é a remetente e eu, a mensageira! 🤖',
