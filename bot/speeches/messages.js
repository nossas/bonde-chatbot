...
export default {
  ...
  */
  ...
  WHATS_ADPF442_1: 'A ADPF do momento é a de número 442. Ela foi protocolada pela Anis e pelo PSOL para questionar artigos do código penal de 1940 que criminalizam o aborto.',
  ...
  WHATS_ADPF442_A: 'Ela tá andando! 🏃🏾‍ Depois de vários setores do governo darem suas posições, a ministra Rosa Weber, relatora (responsável) da ação, chamou audiências públicas pra ouvir especialistas sobre o tema. Vai entrar pra história!',
  WHATS_ADPF442_A1: 'As audiências vão acontecer nos dias 4 e 6 de agosto em Brasília e prometem fazer o STF tremer! Foram convidadas tantas especialistas incríveis que defendem a descriminalização, fico boba e cheia de crushes. 😻 Quer saber como fazer sua opinião chegar até lá também?',
  ...
  ADPF_MORE_ABOUT_ABORTION_A1: 'Na prática ainda é difícil realizar o aborto permitido por lei. O Censo do Aborto Legal (2013) encontrou apenas 37 serviços que realizavam o aborto em caso degravidez decorrente de estupro, 30 em caso de anencefalia e 27 em caso derisco de morte para a mulher - no Brasil todo!',
  ...
  ADPF_MORE_ABOUT_ABORTION_B: '👉 Passo 2: saúde e aborto! Muita gente acha que realizar um aborto é super perigoso, mas não é bem assim. A Organização Mundial da Saúde (OMS) fala em dois métodos seguros: o aborto com medicamentos e o aborto por procedimento médico. Se feito em condições legais, segundo a OMS, é tão seguro que o aborto por medicamentos, nas primeiras 9 semanas de gestação, pode ser feito pela própria mulher, em casa! E ainda apresenta menos riscos que um parto, por exemplo.',
  ...
  ADPF_MORE_ABOUT_ABORTION_D1: 'Como se não bastasse a cada 2 dias morre uma mulher por causa de aborto inseguro, mulheres negras têm duas vezes e meia mais chances de morrer durante um aborto do que as mulheres brancas. As definições de sistema desatualizado foram redefinidas. 🚨🚨',
  ...
  ADPF_MORE_ABOUT_ABORTION_F: '"Se o aborto for descriminalizado, todo mundo vai abortar!" MIGO SEU LOKO!  Descriminalizar o aborto quer dizer que as mulheres não vão para a cadeia por terem abortado, nenhuma vai ser obrigada a abortar! Em Portugal, 10 anos depois da legalização, foram realizados 10% menos abortos e nenhuma mulher morreu por complicações. 😉',
  ...
  ADPF_MORE_ABOUT_ABORTION_I: '"Mas é uma vida!" A biologia não sabe resolver o grande dilema de se a vida começa a concepção. As leis brasileiras apontam que não, tanto que falam em proteger a vida e permitem o aborto em 3 casos. Mas essa nem é a grande questão! Cada um é livre pra acreditar no que quiser, mas não é justo exigir a proibição do aborto com base nisso. E sabe o que é inegável? A mulher gestante tem vida e deveria ter o direito de decidir sobre ela.',
  ...
  ADPF_MORE_ABOUT_ABORTION_C: 'Existe hoje uma ação no Supremo Tribunal Federal (STF), a ADPF 442, para descriminalizar o aborto no Brasil! Nos dias 4 e 6 de agosto vão rolar audiências públicas no STF com especialistas sobre o tema - histórico!',
  ...
  */
  ...
  // Escola sem partido
  EDUCATION:'Desde julho, está pra ser votada uma proposta na Câmara dos Deputados que condena as próximas gerações a mais desigualdade de gênero, mais violência contra a mulher, mais violência contra LGBTs e tantos outros absurdos. Já fizemos muita pressão: enviamos mais de 17 mil emails para cada deputado/a e conseguimos impedir a votação duas vezes 🤘. Ela ainda não tem data pra acontecer, mas precisamos continuar mobilizadas pra que ela não volte tão cedo!Tá comigo? 💪',
