...
export default {
  ...
  */
  ...
  // Escola sem partido
  EDUCATION:'#SOS 🚨 O Congresso pode votar nesta quarta-feira (11/07) uma proposta que condena as próximas gerações a mais desigualdade de gênero, mais violência contra a mulher, mais violência contra LGBTs e tantos outros absurdos. Já fizemos muita pressão e a 1ª votação foi cancelada, agora é hora de mostrarmos que continuamos mobilizadas. Precisamos nos unir para barrar esse retrocesso! Tá comigo? 💪',
