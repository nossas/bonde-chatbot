...
export default {
  ...
  */
  ...
  PEC29_B_1: 'A PEC 29 foi originalmente proposta em 2015, pelo ex-senador Magno Malta (PR/ES). Mas eles gostam tanto de meter o bedelho nos direitos das mulheres que não iam deixar essa proposta de fora da lista de retrocessos de 2019. O que eles fizeram? Correram pra desenterrar essa bizarrice! 🙄 O texto original quer fazer a linha sutil, inserindo no artigo 5º da Constituição que a vida “começa desde a concepção”. Sabe o que isso quer dizer? Que quando o óvulo e o espermatozóide se encontram, esse zigoto tem o mesmo direito que VOCÊ! 😒😒',
  PEC29_B_2: 'É tanto cinismo, que agora inventaram emendas que dizem permitir a interrupção da gravidez nos casos já previstos na lei: em decorrência de estupro, quando o feto é anencéfalo e quando a mulher corre risco de morte. Só que a gente não é besta e sabe que, se a PEC 29 for aprovada, vai gerar uma confusão jurídica tão grande que vai ser cada vez mais difícil conseguir abortar nesses casos! E sobra pra quem? Pras mulheres! 😳 Eu acho que NINGUÉM tem que gerar um feto sem chance de sobrevivência, fruto de uma violência sexual ou que coloque sua própria vida em risco. E conto com você pra que eles #ParemAPEC29. Vamos juntas? 💪💪',
  PEC29_C: 'Sabia que você não ia me decepcionar! 😍 A PEC 29 vai ser votada no dia 8/05 e temos até lá pra ENCHER a caixa de e-mail dos senadores e levar nossa voz até Brasília, exigindo que #ParemAPEC29! Preparei uma mensagem padrão: ela já está prontinha e vou usar meus dotes de robô 🤖 pra enviá-la em seu nome pra cada um deles. Temos pouco tempo pra pressioná-los e garantir que não aprovem esse retrocesso. A HORA É AGORA:',
  PEC29_D: 'Prezados/as senadores/as, sabendo que o direito à vida protegido pelo artigo 5º da Constituição refere-se a pessoas NASCIDAS, deve-se prezar legislações que garantam a vida das mulheres. A PEC 29/2015 é um retrocesso, ao passo que ameaça extinguir direitos fundamentais: interrupção de gestações de fetos anencéfalos, em decorrência de estupro ou que coloquem em risco a vida da gestante. A emenda da relatora, senadora Juíza Selma, provoca uma confusão jurídica que não garante esses direitos já conquistados e reafirmados pelo STF. Exigimos que a PEC 29 seja arquivada! Para responder publicamente, envie um email para beta@nossas.org',
}
