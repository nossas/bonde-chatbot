...
export default botData => ({
  ...
  messages: {
    ...
    [GET_STARTED]: {
      ...
      quick_replies: [
        replyText(botSpeeches.buttonTexts.I_WANT_TO_ACT_NOW, QUICK_REPLY_A),
        replyText(botSpeeches.buttonTexts.TELL_ME_MORE, QUICK_REPLY_B),
      ],
    },
    [QUICK_REPLY_A]: {
      text: botSpeeches.messages.NASCITURO_BILL_PRESSURE_STRATEGY,
      quick_replies: [
        replyText(botSpeeches.buttonTexts.LETS_GO, QUICK_REPLY_C),
        replyText(botSpeeches.buttonTexts.HOW_IT_WORKS, QUICK_REPLY_D),
      ],
    },
    [QUICK_REPLY_B]: {
    ...
    [QUICK_REPLY_D]: {
      ...
      quick_replies: [
        replyText(botSpeeches.buttonTexts.COUNT_ME_IN, QUICK_REPLY_F),
        replyText(botSpeeches.buttonTexts.NOT_NOW, QUICK_REPLY_E),
      ],
    },
    [QUICK_REPLY_E]: {
    ...
    [QUICK_REPLY_H]: profile => ({
      ...
      quick_replies: [
        replyText(botSpeeches.buttonTexts.OF_COURSE, QUICK_REPLY_J)
      ]
    }),
    [QUICK_REPLY_J]: ({
      attachment: {
    ...
    [EMAIL_ADDRESS_OK]: {
      ...
      quick_replies: [
        replyText(botSpeeches.buttonTexts.SEND, QUICK_REPLY_H),
      ],
    },
  }
})
