...
export default {
  ...
  */
  ...
  REABERTURA_PEROLA_3: 'Pra piorar, os casos de violência doméstica já começaram a crescer nas primeiras semanas de isolamento. Em alguns lugares o aumento de casos já foi de 50% e é provável que a demanda pelo serviço também aumente com o tempo. Ou seja: bem na hora que a gente mais precisa de apoio, o Estado solta a mão das mulheres e expõe a gente a ainda mais violência. Bora pressionar pelo fim dessa barbaridade? ',
  ...
  REABERTURA_PEROLA_5: 'Prezado José Henrique Germann, a despeito do Covid-19, as mulheres com gravidez decorrente de estupro, feto anencéfalo e risco à própria vida precisam ter na secretaria de saúde um local de suporte para interrupção da gestação. Há localidades em que o aumento de casos de violência contra a mulher ultrapassa os 50% por conta do isolamento social, ou seja, no momento de maior vulnerabilidade as mulheres não podem ficar desassistidas. Conto com o Senhor para que o atendimento no Pérola Byington, hospital referência em aborto legal de SP, seja normalizado o quanto antes. Para responder publicamente, envie um email para beta@nossas.org',
