...
export default {
  ...
  ABOUT_PEROLA_BYINGTON_: 'O Hospital Pérola Byington fica em SP e é referência no atendimento de vítimas de violência sexual e no aborto legal no Brasil todo. Em março, em meio ao boom do coronavírus, os atendimentos foram suspensos, sob a justificativa de não ocupar leitos de UTI. Eu não caí nesse papo, já que são os aborto clandestinos os mais inseguros e sujeitos à complicações que podem levar mulheres à UTI. Chamei minhas manas, pressionamos a Secretaria de Saúde, e foi sucesso garantido: o serviço voltou em poucos dias! 🤩',
  //
  // New Script
  //
  ...
  */
  ...
  YOU_ROCK_1: 'Compartilhe o meu link com suas amigas - e amigos! Quanto mais pessoas falarem comigo agora, mais pessoas vou conseguir mobilizar para entrar em ação! Vamos nessa? Basta clicar no ícone “encaminhar”, que vai aparecer do ladinho da imagem e mandar #ChamaBetaNoInbox pra todo mundo! 😍',
  ...
  EMAIL_SENT_CONTRA_ESCOLA_SEM_PARTIDO: name => `Arrasou, ${name}! 👏👏 Temos uma última missão: pra nossa voz ser ouvida, precisamos potencializar o coro. É hora de juntar nosso bonde! Compartilhe a campanha com 5 amigues e convide eles a se juntarem a nossa pressão:`,
  ...
  PEC_29_RADAR_1: 'A PEC 29 é absurda! Basicamente, ela acaba com o aborto legal no Brasil. Ou seja: se ela for aprovada, mesmo mulheres que engravidaram depois de serem estupradas vão ser obrigadas a levar a gravidez adiante. Tudo com aquele papinho de que óvulo + espermatozóide é igualzinho a um sujeito de direitos como VOCÊ! A PEC 29 tramita desde 2015, mas em 2019 voltou pra assombrar os direitos das mulheres. Claro que não deixamos barato, né? 😏',
  PEC_29_RADAR_2: 'Não fiz nada sozinha, porque com vocês ando melhor! Juntas, enviamos MAIS DE 100 MIL E-MAILS para os membros da Comissão de Constituição e Justiça (CCJ) do Senado - foi a maior campanha da minha história! 🥰 A pressão foi tão grande que eles não tiveram mais coragem de botar pra frente: a PEC saiu de pauta e nunca mais voltou.',
  PEC_29_RADAR_3: 'Eu aposto que nesse exato minuto os fundamentalistas contrários aos direitos das mulheres devem estar bolando um plano mirabolante pra enfiar a PEC 29 na pauta de novo 👀 Mas fica tranquila: eu passo dia e noite monitorando essa proposta e, a qualquer sinal de retorno, eu te chamo pra gente enterrar esse retrocesso de uma vez por todas! ',
  PEC_29_RADAR_4: 'A PEC 29 foi originalmente proposta em 2015 pelo ex-senador Magno Malta (PR/ES). Mas eles gostam tanto de meter o bedelho nos direitos das mulheres que não iam deixar essa proposta de fora da lista de retrocessos de 2019. O que eles fizeram? Correram pra desenterrar essa bizarrice! 🙄 O texto original quer fazer a linha sutil, inserindo no artigo 5º da Constituição que a vida “começa desde a concepção”. Uma manobra narrativa pra dizer que um zigoto tem mais direitos que uma mulher nascida e com história de vida. 😒😒',
  PEC_29_RADAR_5: 'É tanto cinismo, que eles inventaram emendas para permitir a interrupção da gravidez nos casos já previstos na lei: em decorrência de estupro, quando o feto é anencéfalo e quando a mulher corre risco de morte. Só que a gente não é besta e sabe que, se a PEC 29 for aprovada, vai gerar uma confusão jurídica tão grande que vai ser cada vez mais difícil conseguir abortar nesses casos! E sobra pra quem? Pras mulheres! 😳 Por isso eu nem pisco e já tô pronta pra agir se ousarem desenterrar ela de novo!',

  RES_2232_RADAR_1: 'Nem só no Congresso Nacional vivem as ameaças aos direitos das mulheres. No finalzinho de 2019 foi a vez do Conselho Federal de Medicina (CFM) atacar nosso direito de escolha. #SemLimites A resolução 2232 diz que é “abuso de direito” uma gestante se recusar a ser submetida a qualquer procedimento durante o parto - mesmo aqueles dolorosos e desnecessários. Espera que piora: o Ministério Público Federal (MPF) pediu a revogação da resolução e sabe o que CFM fez?',
  RES_2232_RADAR_2: 'IGNOROU! 😒O Conselho soltou um monte de textão tentando convencer todo mundo que a resolução era ótima e que protegia o feto #obsessão. O grande objetivo, na real, é mais uma vez tentar garantir que qualquer pessoa (nesse caso, um médico!) tenha mais direito ao corpo da mulher do que ela mesma. Pensa que eu fiquei parada?',
  RES_2232_RADAR_3: 'Ah amore, me juntei com umas manas brabas que tão na luta pelos direitos reprodutivos de todas as mulheres e lançamos juntas a campanha #PartoSemViolência. Enviamos mais de 27 mil e-mails pros diretores do CFM e o Ministério Público Federal ficou do nosso lado: ignorado pelo Conselho, o MPF entrou com uma ação civil pública e agora o babado foi parar na justiça! E eu tô aqui, prontinha pra botar meus algoritmos pra jogo e revogar esse desastre de uma vez por todas!',

  REABERTURA_PEROLA_1: 'O machismo quer competir com o coronavírus pra ver quem ameaça mais. 😒Em meio à pandemia, o hospital referência em aborto legal de SP teve a brilhante ideia de SUSPENDER OS ATENDIMENTOS! Eles acham aceitável que mulheres que engravidaram em decorrência de estupro, que correm risco de vida ou que gestam fetos anencéfalos esperem sei lá quanto tempo até a situação normalizar. Falam em não ocupar leitos de UTI, mas são justamente os abortos clandestinos os mais arriscados. Ou seja: não faz sentido! 🤥Tá comigo pra combater essa barbaridade?',
  REABERTURA_PEROLA_2: 'Eu acho mesmo é que tão usando o coronavírus como desculpa pra boicotar a gente. Até os atendimentos que já estavam agendados foram cancelados! Sem a possibilidade de realizar um aborto legal, muitas mulheres serão empurradas pra ilegalidade - só que todo mundo sabe que são os abortos clandestinos que colocam a vida das mulheres em risco. O nome já diz, né: aborto INSEGURO. #TãoÓbvio 🙄',
  REABERTURA_PEROLA_3: 'Pra piorar, os casos de violência doméstica - inclusive violência sexual - já começaram a crescer nas primeiras semanas de isolamento. Em alguns lugares o aumento de casos foi de 50% e é provável que a demanda pelo serviço de aborto legal também aumente com o tempo. Ou seja: bem na hora que a gente mais precisa de apoio, o Estado solta a mão das mulheres e expõe a gente a ainda mais violência. Bora pressionar pelo fim dessa barbaridade?',
  REABERTURA_PEROLA_4: 'Mana, não tem corona que abale nossa parceria! 😍Cada dia sem atendimento no Pérola Byington significa mais mulheres desassistidas. Acho que a Secretaria de Saúde esqueceu seu dever de garantir o aborto legal, com ou sem pandemia. Mas a gente lembra! Quando milhares de mensagens lotarem a caixa de e-mails deles, o serviço vai ter que ser reaberto. Preparei uma mensagem padrão: ela está prontinha e vou usar meus dotes de robô 🤖 pra enviá-la em seu nome pro Secretário de Saúde. A HORA É AGORA, não dá pra esperar a quarentena passar:',
  REABERTURA_PEROLA_5: 'Prezado José Henrique Germann, mulheres com gravidez decorrente de estupro, feto anencéfalo e risco de morte não podem esperar o fim da pandemia para realizarem um aborto.  É dever do Estado ampará-las. Casos de violência doméstica (inclusive sexual) estão crescendo durante o isolamento e é possível que a demanda pelo aborto legal também aumente. Conto com o Senhor para que o atendimento no Pérola Byington, referência em aborto legal, seja normalizado imediatamente. Para responder publicamente, envie um email para beta@nossas.org',
